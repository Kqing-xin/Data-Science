...
REDIS_CONNECTION_STRING = env.str(
    'PROXYPOOL_REDIS_CONNECTION_STRING', env.str('REDIS_CONNECTION_STRING', "redis://@127.0.0.1:6379"))  #配置ip地址
# REDIS_CONNECTION_STRING = env.str(
...
REDIS_KEY = env.str('PROXYPOOL_REDIS_KEY', env.str(
    'REDIS_KEY', 'proxy_poor'))   # 配置数据库名称，修改key
...
# definition of api
API_HOST = env.str('API_HOST', '0.0.0.1')
API_PORT = env.int('API_PORT', 5555)
API_THREADED = env.bool('API_THREADED', True)

# flags of enable
ENABLE_TESTER = env.bool('ENABLE_TESTER', False)   # 测试现有代理服务器有效性
ENABLE_GETTER = env.bool('ENABLE_GETTER', False)  # 获取代理服务器地址
ENABLE_SERVER = env.bool('ENABLE_SERVER', True)  # 启动服务器
